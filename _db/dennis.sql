...
DROP DATABASE IF EXISTS logtime;
CREATE DATABASE IF NOT EXISTS logtime DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE logtime;
...
CREATE TABLE IF NOT EXISTS `categorie_tasks` (
...
(3, 'De hoven', 'hoven', NULL, 0, 1, 0, '2015-03-18 22:57:37', '2015-04-22 19:40:15', 1);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `lasttime_online` timestamp NULL,
